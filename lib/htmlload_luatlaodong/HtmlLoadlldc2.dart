...
class HtmlLoadlldc2Screen extends StatelessWidget {
  const HtmlLoadlldc2Screen({Key? key}) : super(key: key);
  @override
...
class WebViewLoadUI extends State<WebViewLoad>{
  ...
  String htmlFilePath = 'assets/html/luatlaodong/chuong2llaodong.html';
  loadLocalHTML() async{
