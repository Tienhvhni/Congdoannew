...
class HtmlLoadlldc3Screen extends StatelessWidget {
  const HtmlLoadlldc3Screen({Key? key}) : super(key: key);
  @override
...
class WebViewLoadUI extends State<WebViewLoad>{
  ...
  String htmlFilePath = 'assets/html/luatlaodong/chuong3llaodong.html';
  loadLocalHTML() async{
