...
class HtmlLoadlldc12Screen extends StatelessWidget {
  const HtmlLoadlldc12Screen({Key? key}) : super(key: key);
  @override
...
class WebViewLoadUI extends State<WebViewLoad>{
  ...
  String htmlFilePath = 'assets/html/luatlaodong/chuong12llaodong.html';
  loadLocalHTML() async{
