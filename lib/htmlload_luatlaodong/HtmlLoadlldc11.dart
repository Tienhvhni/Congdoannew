...
class HtmlLoadlldc11Screen extends StatelessWidget {
  const HtmlLoadlldc11Screen({Key? key}) : super(key: key);
  @override
...
class WebViewLoadUI extends State<WebViewLoad>{
  ...
  String htmlFilePath = 'assets/html/luatlaodong/chuong11llaodong.html';
  loadLocalHTML() async{
