...
class HtmlLoadlldc6Screen extends StatelessWidget {
  const HtmlLoadlldc6Screen({Key? key}) : super(key: key);
  @override
...
class WebViewLoadUI extends State<WebViewLoad>{
  ...
  String htmlFilePath = 'assets/html/luatlaodong/chuong6llaodong.html';
  loadLocalHTML() async{
