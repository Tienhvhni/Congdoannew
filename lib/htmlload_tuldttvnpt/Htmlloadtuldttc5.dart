...
class Htmlloadtuldttc5Screen extends StatelessWidget {
  const Htmlloadtuldttc5Screen({Key? key}) : super(key: key);
  @override
...
class WebViewLoadUI extends State<WebViewLoad>{
  ...
  String htmlFilePath = 'assets/html/tuldttvnpt/chuong5tuldtt.html';
  loadLocalHTML() async{
