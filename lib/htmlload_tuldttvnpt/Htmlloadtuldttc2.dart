...
class Htmlloadtuldttc2Screen extends StatelessWidget {
  const Htmlloadtuldttc2Screen({Key? key}) : super(key: key);
  @override
...
class WebViewLoadUI extends State<WebViewLoad>{
  ...
  String htmlFilePath = 'assets/html/tuldttvnpt/chuong2tuldtt.html';
  loadLocalHTML() async{
