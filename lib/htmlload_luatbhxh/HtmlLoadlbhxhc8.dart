...
class HtmlLoadlbhxhc8Screen extends StatelessWidget {
  const HtmlLoadlbhxhc8Screen({Key? key}) : super(key: key);
  @override
...
class WebViewLoadUI extends State<WebViewLoad>{
  ...
  String htmlFilePath = 'assets/html/luatbhxh/chuong8lbhxh.html';
  loadLocalHTML() async{
