...
class HtmlLoadlbhxhc1Screen extends StatelessWidget {
  const HtmlLoadlbhxhc1Screen({Key? key}) : super(key: key);
  @override
...
class WebViewLoadUI extends State<WebViewLoad>{
  ...
  String htmlFilePath = 'assets/html/luatbhxh/chuong1lbhxh.html';
  loadLocalHTML() async{
