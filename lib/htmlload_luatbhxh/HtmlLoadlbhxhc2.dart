...
class HtmlLoadlbhxhc2Screen extends StatelessWidget {
  const HtmlLoadlbhxhc2Screen({Key? key}) : super(key: key);
  @override
...
class WebViewLoadUI extends State<WebViewLoad>{
  ...
  String htmlFilePath = 'assets/html/luatbhxh/chuong2lbhxh.html';
  loadLocalHTML() async{
