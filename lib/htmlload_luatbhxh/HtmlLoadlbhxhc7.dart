...
class HtmlLoadlbhxhc7Screen extends StatelessWidget {
  const HtmlLoadlbhxhc7Screen({Key? key}) : super(key: key);
  @override
...
class WebViewLoadUI extends State<WebViewLoad>{
  ...
  String htmlFilePath = 'assets/html/luatbhxh/chuong7lbhxh.html';
  loadLocalHTML() async{
