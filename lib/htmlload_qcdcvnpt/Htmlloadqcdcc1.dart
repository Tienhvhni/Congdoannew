...
class HtmlLoadqcdcc1Screen extends StatelessWidget {
  const HtmlLoadqcdcc1Screen({Key? key}) : super(key: key);
  @override
...
class WebViewLoadUI extends State<WebViewLoad>{
  ...
  String htmlFilePath = 'assets/html/qcdcvnpt/chuong1lqcdc.html';
  loadLocalHTML() async{
